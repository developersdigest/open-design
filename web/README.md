...
Next.js 16 frontend for the Brand Forge n8n demo. This README covers the `web/` app only - see the root `README.md` for the full picture (n8n workflows, end-to-end flow, deployment).
